      ...
      <div className="w-full max-w-md bg-[#0b101b] border border-[#1a273e] rounded-3xl p-8 shadow-2xl space-y-6">
        <div className="text-center space-y-2">
          ...
          <p className="text-xs text-[#8899aa]">
            Sign in to access your wallet, place wagers, and listen to host commentary.
          </p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <button
            type="submit"
            disabled={loading}
            className="w-full py-3.5 rounded-xl bg-gradient-to-r from-[#00e676] to-[#00c853] text-black font-extrabold text-sm hover:opacity-95 transition-all shadow-lg shadow-[#00e676]/20 flex items-center justify-center gap-2 disabled:opacity-50"
          >
